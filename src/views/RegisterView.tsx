    ...
    <>
      ...
      >
        <div className="grid grid-cols-1 space-y-3">
          ...
          {errors.name && <ErrosMessage>{errors.name.message}</ErrosMessage>}
        </div>
        <div className="grid grid-cols-1 space-y-3">
          ...
          />
          {errors.email && <ErrosMessage>{errors.email.message}</ErrosMessage>}
        </div>
        <div className="grid grid-cols-1 space-y-3">
        ...
        <div className="grid grid-cols-1 space-y-3">
          ...
          />
          {errors.password && <ErrosMessage>{errors.password.message}</ErrosMessage>}
        ...
        <div className="grid grid-cols-1 space-y-3">
          ...
          />
          {errors.password_confirmation && <ErrosMessage>{errors.password_confirmation.message}</ErrosMessage>}
        </div>
